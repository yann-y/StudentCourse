...
public class Update1PassDilog extends JDialog implements ActionListener{
	...
	JButton Reset;
	JButton Cancle;
	public Update1PassDilog(JFrame owner){
		super(owner,"密码修改");
					...
					try{
				       ...
				       try{ 
				          ...
				          // String Oldpassword=new String(jtfStudentOldpassword.getPassword()).trim();
				           ...
				           String s="UPDATE users SET userpwd='"+Newpassword+"' where userid='"+id+"'";
